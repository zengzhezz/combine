...
<body>
  ...
  <div id="sidebar" style="width:12% ;height: 80%;top: 50px;" >
    <ul class="menu" style="width:100%;">
      ...
      <li class="current"><a href="index"> <i class="fa fa-address-book-o "></i><span>实时显示</span></a></li>
  ...
  <div class="checkbox" style="position:relative; left: 12%; top:50px; width: 88%;">
    选择要显示的类型:
    <label><input id="show_oldman" type="checkbox" value="" checked/> 住养人员 </label>
    ...
    <label><input id="show_location_node" type="checkbox" value="" checked/>定位节点 </label>
  ...
  <div class="flow_message" style="position:relative; left: 12%; top:60px; width: 88%;">
    <table class="my"  style="width: 100%;">
     <%-- <tr class='first'>
       <td>时间</td>
        <td>uuid</td>
        <td>姓名</td>
